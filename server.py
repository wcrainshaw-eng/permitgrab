...
# V506: Bing Webmaster Tools verification + IndexNow protocol key
app.config['BING_VERIFICATION'] = os.environ.get('BING_VERIFICATION', '')
app.config['INDEXNOW_KEY'] = os.environ.get('INDEXNOW_KEY', '')
...
# V536: calculate_lead_score + add_lead_scores moved to lead_scoring/
# package. Re-exported here so existing in-server-py callsites and
# `from server import calculate_lead_score` consumers keep resolving.
from lead_scoring import calculate_lead_score, add_lead_scores  # noqa: F401, E402
...
# V537: 4 permit-data transforms moved to permit_processing/.
# Re-exported here so existing in-server-py callsites and any
# `from server import format_permit_address` consumer keep resolving.
from permit_processing import (  # noqa: F401, E402
    reclassify_permit,
