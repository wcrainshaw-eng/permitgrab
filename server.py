...
# ===========================
# Routes that used to live in this file have been moved into routes/<category>.py
# and are registered here. This block runs at the very end of server.py module
# body so blueprints can `from server import *` and get everything that was
# defined above.
