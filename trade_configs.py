...
TRADE_REGISTRY = {
    ...
    "interior-renovation": {
        ...
        "keywords": ["interior", "interior renovation", "interior remodel", "interior finish", "fit out", "fitout", "tenant finish"],
        "icon": "🛠️",
        "color": "#A855F7",
        "description_template": "interior renovation permits including office fit-outs, tenant improvements, and interior remodeling",
        "buyer_phrase": "interior renovation contractors",
        "related_trades": ["general-construction", "painting"],
    },
    "windows-doors": {
        "slug": "windows-doors",
        "name": "Windows & Doors",
        "keywords": ["window", "windows", "door", "doors", "storefront", "glazing", "fenestration", "curtain wall"],
        "icon": "🪟",
        "color": "#0EA5E9",
        "description_template": "window and door permits including replacements, storefronts, and glazing installations",
        "buyer_phrase": "window and door contractors",
        "related_trades": ["general-construction", "roofing"],
    },
    "structural": {
        "slug": "structural",
        "name": "Structural",
        "keywords": ["structural", "steel", "framing", "load bearing", "beam", "column", "foundation repair", "seismic"],
        "icon": "🏛️",
        "color": "#6366F1",
        "description_template": "structural permits including steel work, framing, load-bearing modifications, and seismic upgrades",
        "buyer_phrase": "structural contractors",
        "related_trades": ["general-construction", "concrete"],
    },
    "landscaping-exterior": {
        "slug": "landscaping-exterior",
        "name": "Landscaping & Exterior",
        "keywords": ["exterior", "site work", "grading", "hardscape", "outdoor", "yard", "garden"],
        "icon": "🌳",
        "color": "#15803D",
        "description_template": "landscaping and exterior permits including site work, hardscaping, and outdoor improvements",
        "buyer_phrase": "landscaping and exterior contractors",
        "related_trades": ["landscaping", "concrete"],
    },
    "addition": {
        "slug": "addition",
        "name": "Addition",
        "keywords": ["addition", "add on", "extension", "expand", "enlarge", "build out"],
        "icon": "➕",
        "color": "#0D9488",
        "description_template": "building addition permits including home extensions, room additions, and property expansions",
        "buyer_phrase": "addition contractors",
        "related_trades": ["general-construction", "roofing"],
    },
    "all-trades": {
        "slug": "all-trades",
        ...
        "icon": "📋",
        "color": "#6B7280",
        "description_template": "all permit types across all trades and categories",
        "buyer_phrase": "contractors",
        "related_trades": [],
    },
}
