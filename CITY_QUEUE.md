...
- Richmond VA: Socrata data.richmondgov.com. Permits: on portal (resource ID TBD). Violations: needs investigation. Contractor field unconfirmed. BLITZ 2026-04-26. **V422 probe 2026-04-26: ryhf-m453 "Permit Applications" CONFIRMED — direct catalog at data.richmondgov.com (not federated) returned 200; last updatedAt 2026-04-26T19:15Z (TODAY, daily updates per description). Schema sampling blocked by Render SSH instability — re-probe next iteration to confirm contractor field. Earlier dead-end note (line 171) was a federated-catalog miss, not a true dead-end.**
